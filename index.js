...
bot.on("ready", () => { // When the bot is ready
    ...
    console.log(bot.guilds.size+" Servers, "+bot.users.size+" Users "+bot.channels.size+" channels");
});
    ...
    switch(command){
        ...
        case "help":
            var helpEmbed = new Discord.RichEmbed() // Creates a new rich embed (see https://discord.js.org/#/docs/main/stable/class/RichEmbed)
                ...
                .addField("👑 Administrator commands", // Sets the title of the field
                    "**"+config.prefix+"setcredits [@member] [number] ** - Change the number of credits of the mentioned member!\n"+
                    "**"+config.prefix+"premium [@member] ** - Upgrade to premium member or remove premium from a member!\n"+
                ...
                .addField("👨 User Controls", // Sets the title of the field
                    "**"+config.prefix+"profile (@member) ** - Show a member's profile!\n"+
                    ...
                    "**"+config.prefix+"pay [@member] [amount] ** - Pay a member!\n"+
        ...
        */
        case "profile":
            ...
            var profileEmbed = new Discord.RichEmbed() // Creates a new rich embed (see https://discord.js.org/#/docs/main/stable/class/RichEmbed)
                ...
                .setDescription(data.desc !== "unknow" ? data.desc : "No biography recorded!")
                // Display the amount of credits of the member
                .addField("💰 Money", "**"+data.credits+"** credits(s)", true)
                ...
                .addField("📅 Registered", "at "+data.registeredAt, true)
        ...
        */
        case "pay":
            ...
            if(member.id === message.author.id){
                return message.reply("You can't afford to pay yourself!");
            }
        ...
        */
        case "rep":
            ...
            if(isInCooldown){
                ...
                if(isInCooldown > Date.now()){
                    let delay = functions.convertMs(isInCooldown - Date.now()); 
                    return message.reply("You must wait "+ delay +" before you can execute this command again!");
                }
            }
            ...
            message.reply("You have given ** "+ member.user.username +" ** a reputation point!");
            break;
        ...
        */
        case "leaderboard":
            ...
            var table = new AsciiTable("LEADERBOARD").setHeading("", "User", "Money", "Reputation");
        ...
        */
        ...
        case "setcredits":
            ...
            message.reply("credits defined at **"+toAdd+"** for **"+member.user.username+"** !");
            break;
       ...
       case "premium":
        // if the user is not administrator
            ...
            if(membersData[0].premium === "false"){
                ...
                message.channel.send(":tada: Congratulation "+member+" ! You are now one of the premium members!");
            } 
        ...
        */
        case "cooldown":
            ...
            // Send a success message
            message.reply("** "+ member.user.username +" ** cooldown for the command ** "+ cmd +" ** has been reset!");
            break;
    }
